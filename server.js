  ...
  http.createServer(
    async (
      ...
      try {
        ...
        // ====================================================
        // KOALA STORE — EXPERIENCE MOBILE E-COMMERCE
        // ====================================================
...
<style>
:root{--ink:#111827;--muted:#6b7280;--line:#e5e7eb;--bg:#f6f7f8;--green:#177a45;--green2:#0f6136;--soft:#eaf7ef;--orange:#ff7a00;--danger:#c2413b}
*{box-sizing:border-box;-webkit-tap-highlight-color:transparent}
html{scroll-behavior:smooth}
body{margin:0;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif;background:#fff;color:var(--ink);padding-bottom:86px}
button,input{font:inherit}.hidden{display:none!important}
.top{position:sticky;top:0;z-index:40;background:#fff;border-bottom:1px solid var(--line);padding:calc(8px + env(safe-area-inset-top)) 12px 10px}
.logo{text-align:center;font-size:21px;font-weight:950;letter-spacing:.3px;color:var(--green);margin-bottom:9px}.logo span{background:var(--soft);padding:5px 13px;border-radius:999px}
.searchRow{display:flex;gap:8px}.search{flex:1;height:48px;border:2px solid #111;border-radius:26px;padding:0 16px;font-size:17px;outline:0}.searchBtn{width:48px;height:48px;border:0;border-radius:50%;background:#111;color:#fff;font-size:20px}
.tabs{display:flex;gap:20px;overflow:auto;padding:12px 2px 0;scrollbar-width:none}.tabs::-webkit-scrollbar{display:none}.tab{white-space:nowrap;font-weight:800;color:#737373;border:0;background:none;padding:0 0 7px}.tab.active{color:#111;border-bottom:4px solid #111}
.promo{display:flex;gap:8px;overflow:auto;padding:10px 12px;background:#fff4e7;border-bottom:1px solid #f7e2c8}.pill{white-space:nowrap;background:#fff;border-radius:12px;padding:8px 11px;font-size:13px;font-weight:800;color:var(--green)}
.hero{margin:12px;border-radius:20px;padding:19px;background:linear-gradient(135deg,#123d2a,#26734b);color:#fff}.hero .eyebrow{font-size:12px;font-weight:900;letter-spacing:1.4px;opacity:.8}.hero h1{font-size:28px;line-height:1.05;margin:7px 0}.hero p{margin:0;opacity:.9;line-height:1.35}.hero .heroBtn{margin-top:14px;border:0;background:#fff;color:#17472f;padding:10px 14px;border-radius:14px;font-weight:900}
.sectionHead{display:flex;align-items:end;justify-content:space-between;padding:10px 12px 6px}.sectionHead h2{margin:0;font-size:22px}.sectionHead span{font-size:13px;color:var(--muted)}
.grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:2px;background:#eee}.product{background:#fff;padding:0 0 12px;position:relative;min-width:0}.visual{aspect-ratio:1/1;background:linear-gradient(145deg,#f2f4f2,#e9eeea);display:flex;align-items:center;justify-content:center;font-size:72px;position:relative;overflow:hidden}.visual:after{content:"";position:absolute;width:130px;height:130px;border-radius:50%;background:rgba(255,255,255,.45);right:-45px;top:-45px}.tag{position:absolute;left:8px;top:8px;z-index:2;background:#fff;border-radius:6px;padding:3px 6px;font-size:10px;font-weight:900;color:var(--green);border:1px solid #cfe6d6}.heart{position:absolute;right:8px;top:8px;z-index:3;border:0;background:rgba(255,255,255,.94);width:34px;height:34px;border-radius:50%;font-size:18px}.pbody{padding:8px 9px 0}.pname{font-size:14px;font-weight:750;line-height:1.25;height:35px;overflow:hidden}.stars{font-size:12px;margin-top:5px}.sales{font-size:11px;color:var(--muted)}.priceRow{display:flex;align-items:baseline;gap:6px;margin-top:6px}.price{font-size:19px;font-weight:950}.old{text-decoration:line-through;color:#9ca3af;font-size:11px}.quick{position:absolute;right:8px;bottom:9px;border:1px solid #111;background:#fff;width:35px;height:35px;border-radius:50%;font-size:20px;font-weight:900}
.bottom{position:fixed;bottom:0;left:0;right:0;z-index:50;background:#fff;border-top:1px solid var(--line);padding:7px 5px calc(7px + env(safe-area-inset-bottom));display:grid;grid-template-columns:repeat(5,1fr)}.nav{border:0;background:transparent;font-size:11px;font-weight:700;color:#111;display:flex;flex-direction:column;align-items:center;gap:2px}.nav i{font-style:normal;font-size:23px}.nav.active{color:var(--green)}.count{position:absolute;transform:translate(12px,-4px);background:#e11d48;color:#fff;font-size:10px;min-width:17px;height:17px;border-radius:9px;display:inline-flex;align-items:center;justify-content:center;padding:0 4px}
.overlay{position:fixed;inset:0;background:rgba(0,0,0,.42);z-index:70;display:none}.overlay.open{display:block}.sheet{position:absolute;left:0;right:0;bottom:0;background:#fff;border-radius:24px 24px 0 0;max-height:92vh;overflow:auto;padding-bottom:calc(20px + env(safe-area-inset-bottom))}.sheetTop{position:sticky;top:0;background:#fff;display:flex;align-items:center;justify-content:space-between;padding:14px;border-bottom:1px solid var(--line);z-index:2}.sheetTop h2{margin:0;font-size:21px}.close{border:0;background:#f3f4f6;width:36px;height:36px;border-radius:50%;font-size:22px}.cartLine{display:grid;grid-template-columns:58px 1fr auto;gap:10px;align-items:center;padding:12px;border-bottom:1px solid #eee}.thumb{width:58px;height:58px;border-radius:12px;background:#f0f2f0;display:flex;align-items:center;justify-content:center;font-size:30px}.qty{display:flex;align-items:center;gap:8px;margin-top:6px}.qty button{border:1px solid #ddd;background:#fff;width:29px;height:29px;border-radius:8px;font-weight:900}.remove{border:0;background:none;color:var(--danger);font-size:12px;padding:0;margin-top:7px}.summary{padding:14px}.sumrow{display:flex;justify-content:space-between;margin:9px 0}.sumrow.total{font-size:22px;font-weight:950;border-top:1px solid #ddd;padding-top:13px}.checkout{width:100%;border:0;border-radius:17px;padding:15px;font-weight:900;font-size:17px;margin-top:10px}.koalaPay{background:var(--green);color:#fff}.stripePay{background:#635bff;color:#fff}.plans{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:10px}.plan{border:2px solid #d1d5db;background:#fff;border-radius:14px;padding:12px;font-weight:900}.plan.active{border-color:var(--green);background:var(--soft);color:var(--green)}.secure{text-align:center;color:var(--muted);font-size:12px;margin-top:10px}.empty{padding:35px 18px;text-align:center;color:var(--muted)}
.detailHero{aspect-ratio:1.18/1;background:linear-gradient(145deg,#edf1ee,#dfe9e2);display:flex;align-items:center;justify-content:center;font-size:118px;position:relative}.detailBody{padding:16px}.detailTitle{font-size:21px;font-weight:900;line-height:1.25}.detailPrice{font-size:30px;font-weight:950;margin:8px 0}.benefit{display:flex;gap:8px;overflow:auto;margin:12px -16px;padding:9px 16px;background:#fff4e7;color:var(--green);font-weight:850;font-size:13px}.benefit span{white-space:nowrap}.optionTitle{font-weight:900;margin-top:17px}.options{display:flex;gap:8px;flex-wrap:wrap;margin-top:8px}.opt{border:1px solid #d1d5db;background:#fff;border-radius:12px;padding:9px 12px}.opt.selected{border:2px solid #111}.reviewBox{margin-top:18px;border-top:8px solid #f4f4f4;padding-top:16px}.review{border-bottom:1px solid #eee;padding:12px 0}.review strong{display:block}.stickyBuy{position:sticky;bottom:0;background:#fff;border-top:1px solid #ddd;padding:10px 12px;display:grid;grid-template-columns:1fr 1fr;gap:8px}.stickyBuy button{border-radius:22px;padding:14px 8px;font-weight:900;font-size:16px}.addBtn{border:1px solid #111;background:#fff}.buyBtn{border:0;background:var(--orange);color:#fff}
.panel{padding:18px}.panel h2{margin:0 0 14px}.catGrid{display:grid;grid-template-columns:repeat(3,1fr);gap:10px}.cat{border:1px solid #e5e7eb;border-radius:16px;padding:18px 6px;text-align:center;background:#fff}.cat i{font-style:normal;font-size:32px;display:block;margin-bottom:6px}.notice{margin:12px;padding:12px;border-radius:13px;background:#eefbf3;color:#17663d;font-weight:750}.status{display:none;margin-top:10px;padding:12px;border-radius:12px;background:#fff0ef;color:#8b2722}
@media(min-width:760px){body{background:#f3f5f4}.app{max-width:980px;margin:auto;background:#fff;min-height:100vh;box-shadow:0 0 35px rgba(0,0,0,.06)}.grid{grid-template-columns:repeat(4,1fr)}.bottom{left:50%;transform:translateX(-50%);max-width:980px}.sheet{max-width:700px;left:50%;right:auto;width:100%;transform:translateX(-50%)}}
</style>
</head>
<body>
<div class="app">
<header class="top">
 <div class="logo"><span>🐨 KOALA STORE</span></div>
 <div class="searchRow"><input id="search" class="search" placeholder="Rechercher dans Koala Store"><button class="searchBtn" onclick="applySearch()">⌕</button></div>
 <div class="tabs" id="tabs"><button class="tab active" data-cat="Tout">Tout</button><button class="tab" data-cat="Électronique">Électronique</button><button class="tab" data-cat="Mode">Mode</button><button class="tab" data-cat="Maison">Maison</button><button class="tab" data-cat="Sport">Sport</button></div>
</header>
<div class="promo"><div class="pill">✓ Livraison gratuite</div><div class="pill">✓ Paiement sécurisé</div><div class="pill">🐨 Koala Crypto 3x / 4x</div><div class="pill">↩ Retours faciles</div></div>
<section class="hero"><div class="eyebrow">NOUVELLE EXPÉRIENCE</div><h1>Des offres qui donnent envie.</h1><p>Parcourez, ajoutez au panier et payez par carte ou avec Koala Crypto.</p><button class="heroBtn" onclick="document.getElementById('catalog').scrollIntoView()">Voir les produits</button></section>
<div class="sectionHead" id="catalog"><h2>Meilleurs choix</h2><span id="resultCount"></span></div>
<section class="grid" id="productGrid"></section>
<div class="notice">🔒 Paiement protégé · Panier conservé sur cet appareil</div>
</div>

<nav class="bottom">
 <button class="nav active" onclick="showHome(this)"><i>⌂</i>Accueil</button>
 <button class="nav" onclick="showCategories(this)"><i>◫</i>Catégories</button>
 <button class="nav" onclick="showFavorites(this)"><i>♡</i>Favoris</button>
 <button class="nav" onclick="openCart()"><span style="position:relative"><i>🛒</i><b id="cartCount" class="count">0</b></span>Panier</button>
 <button class="nav" onclick="showAccount(this)"><i>☺</i>Vous</button>
</nav>

<div class="overlay" id="modal" onclick="backdropClose(event)"><div class="sheet" id="sheet"></div></div>

<script>
var PRODUCTS={
 1:{id:1,name:"Écouteurs Nova Pro",price:39.90,old:59.90,cat:"Électronique",emoji:"🎧",rating:4.8,sales:1240,tag:"TOP",desc:"Écouteurs sans fil compacts avec boîtier de charge et réduction de bruit.",options:["Noir","Blanc","Vert"]},
 2:{id:2,name:"Montre Pulse Connect",price:79.90,old:99.90,cat:"Électronique",emoji:"⌚️",rating:4.7,sales:3560,tag:"BEST-SELLER",desc:"Montre connectée avec suivi d'activité, notifications et autonomie longue durée.",options:["Noir","Or","Argent"]},
 3:{id:3,name:"Sac Urban Explorer",price:59.90,old:74.90,cat:"Mode",emoji:"🎒",rating:4.6,sales:842,tag:"NOUVEAU",desc:"Sac urbain léger, résistant et pensé pour le quotidien.",options:["Noir","Sable","Bleu"]},
 4:{id:4,name:"Enceinte Mini Boom",price:49.90,old:69.90,cat:"Électronique",emoji:"🔊",rating:4.9,sales:2140,tag:"TOP",desc:"Enceinte Bluetooth compacte avec son puissant et recharge USB-C.",options:["Noir","Rouge","Bleu"]},
 5:{id:5,name:"Lampe Aura Maison",price:24.90,old:34.90,cat:"Maison",emoji:"💡",rating:4.5,sales:692,tag:"-29%",desc:"Lampe d'ambiance tactile pour chambre, bureau ou salon.",options:["Blanc","Bois"]},
 6:{id:6,name:"Sweat Koala Essential",price:34.90,old:49.90,cat:"Mode",emoji:"🧥",rating:4.8,sales:1188,tag:"TENDANCE",desc:"Sweat confortable coupe moderne, intérieur doux.",options:["S","M","L","XL"]},
 7:{id:7,name:"Kit Fitness Flex",price:19.90,old:29.90,cat:"Sport",emoji:"🏋️",rating:4.7,sales:2904,tag:"SPORT",desc:"Bandes de résistance pour entraînement à la maison.",options:["Léger","Moyen","Fort"]},
 8:{id:8,name:"Chargeur Duo Fast",price:29.90,old:39.90,cat:"Électronique",emoji:"🔌",rating:4.9,sales:4011,tag:"LOCAL",desc:"Chargeur double port compact pour smartphone et accessoires.",options:["EU","USB-C"]}
};
var cart=JSON.parse(localStorage.getItem("koala_cart")||"{}");
var favorites=JSON.parse(localStorage.getItem("koala_favorites")||"[]");
var category="Tout";
var selectedPlan=3;
function esc(s){return String(s).replace(/[&<>\"]/g,function(c){return({"&":"&amp;","<":"&lt;",">":"&gt;","\"":"&quot;"})[c]})}
function euro(n){return Number(n).toLocaleString("fr-FR",{minimumFractionDigits:2,maximumFractionDigits:2})+" €"}
function save(){localStorage.setItem("koala_cart",JSON.stringify(cart));localStorage.setItem("koala_favorites",JSON.stringify(favorites));updateCount()}
function cartQty(){return Object.keys(cart).reduce(function(s,k){return s+Number(cart[k]||0)},0)}
function cartTotal(){return Object.keys(cart).reduce(function(s,k){var p=PRODUCTS[k];return s+(p?p.price*cart[k]:0)},0)}
function updateCount(){document.getElementById("cartCount").textContent=cartQty()}
function renderProducts(){var q=(document.getElementById("search").value||"").trim().toLowerCase();var arr=Object.values(PRODUCTS).filter(function(p){return(category==="Tout"||p.cat===category)&&(!q||p.name.toLowerCase().includes(q)||p.desc.toLowerCase().includes(q)||p.cat.toLowerCase().includes(q))});document.getElementById("resultCount").textContent=arr.length+" articles";var html=arr.map(function(p){var fav=favorites.includes(p.id);return '<article class="product"><div class="visual" onclick="openProduct('+p.id+')"><span class="tag">'+esc(p.tag)+'</span><button class="heart" onclick="event.stopPropagation();toggleFav('+p.id+')">'+(fav?'♥':'♡')+'</button>'+p.emoji+'</div><div class="pbody" onclick="openProduct('+p.id+')"><div class="pname">'+esc(p.name)+'</div><div class="stars">★★★★★ <span class="sales">'+p.rating+' · '+p.sales.toLocaleString("fr-FR")+' ventes</span></div><div class="priceRow"><span class="price">'+euro(p.price)+'</span><span class="old">'+euro(p.old)+'</span></div></div><button class="quick" onclick="addToCart('+p.id+');event.stopPropagation()">＋</button></article>'}).join("");document.getElementById("productGrid").innerHTML=html||'<div class="empty" style="grid-column:1/-1">Aucun produit trouvé.</div>'}
function applySearch(){renderProducts();document.getElementById("catalog").scrollIntoView()}
document.getElementById("search").addEventListener("input",renderProducts);
document.getElementById("tabs").addEventListener("click",function(e){var b=e.target.closest(".tab");if(!b)return;document.querySelectorAll(".tab").forEach(function(x){x.classList.remove("active")});b.classList.add("active");category=b.dataset.cat;renderProducts()});
function addToCart(id,qty){qty=qty||1;cart[id]=(cart[id]||0)+qty;save();toast("Ajouté au panier ✓")}
function changeQty(id,delta){cart[id]=(cart[id]||0)+delta;if(cart[id]<=0)delete cart[id];save();openCart()}
function removeFromCart(id){delete cart[id];save();openCart()}
function toggleFav(id){var i=favorites.indexOf(id);if(i>=0)favorites.splice(i,1);else favorites.push(id);save();renderProducts()}
function openModal(html){document.getElementById("sheet").innerHTML=html;document.getElementById("modal").classList.add("open");document.body.style.overflow="hidden"}
function closeModal(){document.getElementById("modal").classList.remove("open");document.body.style.overflow=""}
function backdropClose(e){if(e.target.id==="modal")closeModal()}
function openProduct(id){var p=PRODUCTS[id];if(!p)return;var opts=p.options.map(function(o,i){return '<button class="opt '+(i===0?'selected':'')+'" onclick="this.parentNode.querySelectorAll(\'.opt\').forEach(function(x){x.classList.remove(\'selected\')});this.classList.add(\'selected\')">'+esc(o)+'</button>'}).join("");openModal('<div class="sheetTop"><h2>Fiche produit</h2><button class="close" onclick="closeModal()">×</button></div><div class="detailHero">'+p.emoji+'</div><div class="detailBody"><div class="detailTitle">'+esc(p.name)+'</div><div>★★★★★ '+p.rating+' · '+p.sales.toLocaleString("fr-FR")+' ventes</div><div class="detailPrice">'+euro(p.price)+' <span class="old">'+euro(p.old)+'</span></div><div class="benefit"><span>✓ Livraison gratuite</span><span>✓ Paiement sécurisé</span><span>↩ Retours faciles</span></div><p>'+esc(p.desc)+'</p><div class="optionTitle">Choisissez une option</div><div class="options">'+opts+'</div><div class="reviewBox"><h3>Avis clients</h3><div class="review"><strong>★★★★★ Achat vérifié</strong>Très bon produit, conforme et simple à utiliser.</div><div class="review"><strong>★★★★★ Achat vérifié</strong>Livraison rapide et produit bien emballé.</div></div></div><div class="stickyBuy"><button class="addBtn" onclick="addToCart('+id+');closeModal()">Ajouter au panier</button><button class="buyBtn" onclick="addToCart('+id+');openCart()">Acheter maintenant</button></div>')}
function openCart(){var keys=Object.keys(cart);var lines=keys.map(function(k){var p=PRODUCTS[k];var q=cart[k];return '<div class="cartLine"><div class="thumb">'+p.emoji+'</div><div><strong>'+esc(p.name)+'</strong><div class="qty"><button onclick="changeQty('+p.id+',-1)">−</button><b>'+q+'</b><button onclick="changeQty('+p.id+',1)">+</button></div><button class="remove" onclick="removeFromCart('+p.id+')">Supprimer</button></div><strong>'+euro(p.price*q)+'</strong></div>'}).join("");if(!keys.length){lines='<div class="empty">🛒<br><br>Votre panier est vide.</div>'}openModal('<div class="sheetTop"><h2>Votre panier ('+cartQty()+')</h2><button class="close" onclick="closeModal()">×</button></div>'+lines+(keys.length?'<div class="summary"><div class="sumrow"><span>Sous-total</span><strong>'+euro(cartTotal())+'</strong></div><div class="sumrow"><span>Livraison</span><strong>Gratuite</strong></div><div class="sumrow total"><span>Total</span><span>'+euro(cartTotal())+'</span></div><h3>Payer avec Koala Crypto</h3><div class="plans"><button id="p3" class="plan '+(selectedPlan===3?'active':'')+'" onclick="selectPlan(3)">3x · '+euro(cartTotal()/3)+'</button><button id="p4" class="plan '+(selectedPlan===4?'active':'')+'" onclick="selectPlan(4)">4x · '+euro(cartTotal()/4)+'</button></div><button class="checkout koalaPay" onclick="payWithKoala()">🐨 Continuer avec Koala Crypto</button><button class="checkout stripePay" id="stripeButton" onclick="payWithCard()">💳 Payer par carte bancaire</button><div class="secure">🔒 Paiement sécurisé</div><div class="status" id="status"></div></div>':'')}
function selectPlan(n){selectedPlan=n;var a=document.getElementById("p3"),b=document.getElementById("p4");if(a&&b){a.classList.toggle("active",n===3);b.classList.toggle("active",n===4)}}
function payWithKoala(){var amount=cartTotal();if(amount<=0)return;var successUrl=window.location.origin+"/store/success";var cancelUrl=window.location.origin+"/store/cancel";var target="https://koala6.onrender.com/?merchant_id=1&amount="+encodeURIComponent(amount.toFixed(2))+"&merchant="+encodeURIComponent("Koala Store")+"&installments="+selectedPlan+"&success_url="+encodeURIComponent(successUrl)+"&cancel_url="+encodeURIComponent(cancelUrl);window.location.href=target}
async function payWithCard(){if(!cartQty())return;var btn=document.getElementById("stripeButton");btn.disabled=true;btn.textContent="Connexion à Stripe...";var ids=[];Object.keys(cart).forEach(function(k){for(var i=0;i<cart[k];i++)ids.push(Number(k))});try{var r=await fetch("/store/card",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({product_ids:ids})});var data=await r.json();if(!r.ok||!data.url)throw new Error(data.error||"Paiement Stripe impossible.");window.location.href=data.url}catch(e){var s=document.getElementById("status");if(s){s.style.display="block";s.textContent=e.message||"Erreur Stripe."}btn.disabled=false;btn.textContent="💳 Payer par carte bancaire"}}
function showCategories(btn){activateNav(btn);openModal('<div class="sheetTop"><h2>Catégories</h2><button class="close" onclick="closeModal()">×</button></div><div class="panel"><div class="catGrid"><button class="cat" onclick="chooseCategory(\'Électronique\')"><i>📱</i>Électronique</button><button class="cat" onclick="chooseCategory(\'Mode\')"><i>👕</i>Mode</button><button class="cat" onclick="chooseCategory(\'Maison\')"><i>🏠</i>Maison</button><button class="cat" onclick="chooseCategory(\'Sport\')"><i>🏃</i>Sport</button><button class="cat" onclick="chooseCategory(\'Tout\')"><i>✨</i>Tout voir</button></div></div>')}
function chooseCategory(c){category=c;document.querySelectorAll(".tab").forEach(function(x){x.classList.toggle("active",x.dataset.cat===c)});renderProducts();closeModal();document.getElementById("catalog").scrollIntoView()}
function showFavorites(btn){activateNav(btn);var arr=favorites.map(function(id){return PRODUCTS[id]}).filter(Boolean);var h=arr.length?arr.map(function(p){return '<div class="cartLine" onclick="openProduct('+p.id+')"><div class="thumb">'+p.emoji+'</div><div><strong>'+esc(p.name)+'</strong><div>'+euro(p.price)+'</div></div><button class="heart">♥</button></div>'}).join(""):'<div class="empty">♡<br><br>Aucun favori pour le moment.</div>';openModal('<div class="sheetTop"><h2>Mes favoris</h2><button class="close" onclick="closeModal()">×</button></div>'+h)}
function showAccount(btn){activateNav(btn);openModal('<div class="sheetTop"><h2>Votre espace</h2><button class="close" onclick="closeModal()">×</button></div><div class="panel"><div style="font-size:58px">🐨</div><h2>Bienvenue sur Koala Store</h2><p>Retrouvez ici vos commandes, vos moyens de paiement et vos préférences.</p><div class="notice" style="margin:12px 0">La connexion client pourra être reliée ensuite au compte Koala Crypto.</div></div>')}
function showHome(btn){activateNav(btn);closeModal();window.scrollTo({top:0,behavior:"smooth"})}
function activateNav(btn){document.querySelectorAll(".nav").forEach(function(x){x.classList.remove("active")});if(btn)btn.classList.add("active")}
function toast(msg){var t=document.createElement("div");t.textContent=msg;t.style.cssText="position:fixed;left:50%;bottom:95px;transform:translateX(-50%);background:#111;color:white;padding:11px 16px;border-radius:18px;z-index:99;font-weight:800;font-size:13px";document.body.appendChild(t);setTimeout(function(){t.remove()},1200)}
